let std : (string * Sexp_t.sexp_t) list =
    ...
    [
        ...
        ("and", f "(.\\ (andl andr) (cond ((eq andl false) false) ((eq andl true) (cond ((eq andr true) true) ((eq andr false) false)))))");
        ("or", f "(.\\ (orl orr) (cond ((eq orl true) true) ((eq orl false) (cond ((eq orr true) true) ((eq orr false) false)))))");
        ("not", f "(.\\ (notx) (cond ((eq notx true) false) ((eq notx false) true)))");
        ("neq", f "(.\\ (neql neqr) (not (eq neql neqr)))");
    ]
